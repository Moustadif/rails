class PaymentTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_type.save
        format.html { redirect_to review_carts_path(id: @current_cart.id), notice: 'Payment type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @payment_type.update(payment_type_params)
        format.html { redirect_to review_carts_path(id: @current_cart.id), notice: 'Payment type was successfully updated.' }
  ...
  private
    ...
    def payment_type_params
      params.require(:payment_type).permit(:payment_via, :cart_id)
    end
end
