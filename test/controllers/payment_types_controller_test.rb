...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { cart_id: @payment_type.cart_id, payment_via: @payment_type.payment_via } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { cart_id: @payment_type.cart_id, payment_via: @payment_type.payment_via } }
