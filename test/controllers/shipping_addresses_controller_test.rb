...
class ShippingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_address" do
    assert_difference('ShippingAddress.count') do
      post shipping_addresses_url, params: { shipping_address: { cart_id: @shipping_address.cart_id, city: @shipping_address.city, state: @shipping_address.state, street: @shipping_address.street, zip: @shipping_address.zip } }
    end
  ...
  test "should update shipping_address" do
    patch shipping_address_url(@shipping_address), params: { shipping_address: { cart_id: @shipping_address.cart_id, city: @shipping_address.city, state: @shipping_address.state, street: @shipping_address.street, zip: @shipping_address.zip } }
