...
class BillingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing_address" do
    assert_difference('BillingAddress.count') do
      post billing_addresses_url, params: { billing_address: { cart_id: @billing_address.cart_id, city: @billing_address.city, state: @billing_address.state, street: @billing_address.street, zip: @billing_address.zip } }
    end
  ...
  test "should update billing_address" do
    patch billing_address_url(@billing_address), params: { billing_address: { cart_id: @billing_address.cart_id, city: @billing_address.city, state: @billing_address.state, street: @billing_address.street, zip: @billing_address.zip } }
