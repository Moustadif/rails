...
class DeliveryTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery_type" do
    assert_difference('DeliveryType.count') do
      post delivery_types_url, params: { delivery_type: { cart_id: @delivery_type.cart_id, delivery_via: @delivery_type.delivery_via } }
    end
  ...
  test "should update delivery_type" do
    patch delivery_type_url(@delivery_type), params: { delivery_type: { cart_id: @delivery_type.cart_id, delivery_via: @delivery_type.delivery_via } }
